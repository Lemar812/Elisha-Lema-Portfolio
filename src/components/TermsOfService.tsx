    ...
    const sections = [
        {
            ...
            content:
                "These Terms of Service ('Terms') govern your access to and use of the website and services provided by Elisha Lema. By accessing or using our website and services, you agree to be bound by these Terms. If you do not agree to any part of these Terms, please refrain from using our services.",
        },
        {
            title: '2. Service Description',
            content:
                "Elisha Lema provides design and development services including:\n\n• Brand Identity and Logo Design\n• Graphic Design and Visual Assets\n• Web Development and Web Application Design\n• Consultation Services\n\nServices are tailored to individual client needs and are delivered according to the terms outlined in the project agreement.",
        },
        {
            title: '3. Intellectual Property Rights',
            content:
                'Upon full payment for services, intellectual property rights for the final deliverables transfer to the client. During the project completion phase and until full payment, all work remains the property of Elisha Lema. Clients may not reproduce, modify, or distribute original designs without explicit written permission.',
        },
        {
            title: '4. Payment Terms',
            content:
                'Payment for services is due as outlined in the project agreement. We accept various payment methods and will provide clear invoicing. Late payments may result in project suspension. A 50% deposit is typically required to initiate projects, with the balance due upon completion.',
        },
        {
            title: '5. Project Timelines',
            content:
                'Project timelines are estimates and subject to change based on project scope, client feedback, and revisions. We will communicate any changes in timelines promptly. Delays caused by client feedback, additional requests, or scope changes may extend delivery dates.',
        },
        {
            title: '6. Revisions and Feedback',
            content:
                'We typically include a specified number of revision rounds in our service packages. Additional revisions beyond the agreed number may incur extra charges. Revision requests should be clear and comprehensive to ensure efficient implementation.',
        },
        {
        ...
        },
        {
            ...
            content:
                'Elisha Lema shall not be liable for any indirect, incidental, special, or consequential damages arising from the use or inability to use our services. Our total liability for any claim shall not exceed the amount paid for the specific service in question.',
        },
        {
        ...
        },
        {
            ...
            content:
                "Our website and services are provided on an 'as-is' basis. We do not guarantee uninterrupted access or error-free operation. We are not responsible for:\n\n• Third-party services or content\n• Loss of data or information\n• Compatibility issues with specific software versions\n• Performance issues due to client's infrastructure",
        },
        {
            title: '13. Indemnification',
            content:
                'You agree to indemnify and hold harmless Elisha Lema from any claims, damages, or losses arising from:\n\n• Your violation of these Terms\n• Your use of our services\n• Content you provide to us\n• Your violation of any applicable laws\n• Infringement of third-party rights through your provided materials',
        },
        {
            title: '14. Governing Law',
            content:
                'These Terms are governed by and construed in accordance with the laws of Tanzania. Any disputes arising from these Terms or our services shall be subject to the jurisdiction of the courts in Tanzania.',
        },
        {
            title: '15. Dispute Resolution',
            content:
                'Before pursuing legal action, we encourage parties to attempt resolving disputes through:\n\n1. Direct communication and negotiation\n2. Mediation with a mutually agreed-upon mediator\n3. Arbitration if mediation fails\n\nOnly after these steps should legal proceedings be initiated.',
        },
        {
            title: '16. Termination',
            content:
                'We reserve the right to terminate or suspend access to our services if you violate these Terms or engage in behavior we deem inappropriate. Termination will not affect obligations incurred before termination.',
        },
        {
            title: '17. Modifications to Terms',
            content:
                'We may update these Terms periodically. Changes will be posted on our website with a new effective date. Continued use of our services after updates constitutes acceptance of the modified Terms. We recommend reviewing these Terms regularly.',
        },
        {
        ...
        },
        {
            ...
            content:
                'These Terms, together with any project agreement and privacy policy, constitute the entire agreement between you and Elisha Lema regarding the services provided. They supersede all prior agreements and understandings.',
        },
        {
