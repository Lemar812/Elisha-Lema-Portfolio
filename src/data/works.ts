export type WorkCategory = 'Logo' | 'Poster/Banner' | "Website's Screenshot";

export const WORK_GALLERY_FILTERS: WorkCategory[] = ['Logo', 'Poster/Banner', "Website's Screenshot"];
...
export const works: Work[] = [
    ...
    },
    {
        ...
        title: 'Our Destiny',
        category: 'Logo',
        imageSrc: '/works/Logos/Our Destiny.png',
        description: 'Identity concept shaped for a clear, memorable, and adaptable brand presence.',
    ...
    {
        id: 'work-21',
        title: 'Lemosho Poster',
        category: 'Poster/Banner',
        imageSrc: '/works/Posters & Banners/Lemosho Poster.jpg',
        description: 'Travel promotion artwork built to present the route clearly and attractively.',
        tags: ['Poster', 'Travel', 'Promo'],
        websiteUrl: '',
    },
    {
        id: 'work-22',
        ...
        category: 'Poster/Banner',
        imageSrc: '/works/Posters & Banners/Tanzania & Zanzibar Poster.jpg',
        description: 'Tourism campaign visual designed to showcase destination appeal with strong hierarchy.',
        tags: ['Poster', 'Travel', 'Campaign'],
        websiteUrl: '',
    },
    {
        id: 'work-19',
