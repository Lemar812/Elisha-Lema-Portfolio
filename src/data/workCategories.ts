...
export const assistantWorkCategories: AssistantWorksCategory[] = [
    {
        ...
        keywords: ['logo', 'logos', 'logo work', 'branding work', 'identity', 'brand identity', 'brand marks', 'business logo', 'safari branding', 'accessories brand identity'],
        target: 'works',
        actionType: 'scroll',
        filter: 'Logo',
    ...
    },
    {
        ...
        keywords: ['poster', 'posters', 'banner', 'banners', 'flyer', 'flyers', 'brochure', 'brochures', 'promo design', 'campaign design', 'church flyer', 'tourism poster'],
        target: 'works',
        actionType: 'scroll',
    ...
    },
    {
        ...
        keywords: ['website', 'websites', 'website projects', 'web project', 'web design', 'web development', 'ui work', 'premium portfolio website', 'business website'],
        target: 'works',
        actionType: 'scroll',
    ...
    },
    {
        ...
        keywords: ['travel', 'travel design', 'travel designs', 'safari', 'safari designs', 'tourism', 'tour designs', 'wildlife poster', 'destination campaign'],
        target: 'works',
        actionType: 'scroll',
