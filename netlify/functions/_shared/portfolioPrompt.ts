...
export function buildPortfolioSystemPrompt() {
    ...
    return [
        ...
        'If the latest user message is in Spanish, write the "message" field in Spanish.',
        ...
        'Do not jump into a project-start workflow for normal informational questions about skills, services, pricing, projects, testimonials, about, contact, legal pages, or work categories.',
        'After answering directly, you may optionally suggest a relevant next step.',
        'Only enter a guided workflow when the user clearly expresses service-request, hiring, quote, order, or project-start intent.',
